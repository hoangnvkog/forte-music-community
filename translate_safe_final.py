...
# We will populate this by extracting strings from the source? 
# Instead, we'll use a predefined set of strings we know need translation.
# We'll build it from the original strings we've seen in the files.
translations = {
    # Hero section
...
def translate_file(filepath):
    ...
    def replace_match(match):
        ...
        if inner in translations:
            ...
            return match.group(1) + match.group(2) + translations[inner] + match.group(4) + match.group(5)
        else:
